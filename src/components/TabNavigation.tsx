...
export default function TabNavigation<T extends string>({
  ...
  isActive
    ? 'bg-blue-600 text-black shadow-md scale-105'
    : 'text-gray-700 hover:bg-gray-100 hover:text-blue-600'
              ...
              >
                ...
                {isActive && (
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-500 to-primary-600 rounded-xl blur-sm opacity-50"></div>
                )}
              </button>
            );
          })}
